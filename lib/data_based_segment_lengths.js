...
var get_vds = require('./get_vds.js')
var get_wim = require('./get_wim.js')
...
function do_it(err,config){
    ...
    firstloop.defer(get_vds)
    firstloop.defer(get_wim)
    firstloop.await(function(err,vds,wim){
        ...
        years.forEach(function(year){
            ...
            secondloop.defer(hit_pg,events)
        })
